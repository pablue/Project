...
/**
 * 
 * @ClassName: WeacherUtil
 * @Description:缺少相互依赖的jar文件，实现天气
 * @author: Enzo
 * @time: 2014年11月22日
 *
 */
public class WeacherUtil {
	...
	public WeacherUtil(String cityid) throws IOException {
		// /解析本机IP地址
		this.Cityid = cityid;
		...
		jsonData = JSONObject.fromObject(sb);
	...
	public static void main(String[] args) {
		try {
			new WeacherUtil("101010100"); // 101010100(北京)就是你的城市代码
			new WeacherUtil("101280101"); // 101280101(广州)就是你的城市代码
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
